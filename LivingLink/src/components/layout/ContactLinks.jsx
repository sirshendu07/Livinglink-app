...
const ContactLinks = () => {
  // Using India country code (+91) for WhatsApp to work correctly
  const phone = "917439282123"; 
  ...
  return (
    <div className="contact-links-container">
      ...
      <div className="social-icons">
        {/* WhatsApp Button */}
        <a href={`https://wa.me/${phone}`} target="_blank" rel="noopener noreferrer" className="social-btn whatsapp" title="WhatsApp">
        ...
        {/* Call Button */}
        <a href={`tel:+${phone}`} className="social-btn call" title="Call Us">
          <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <a href="#" className="social-btn facebook" title="Facebook">
          <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
          </svg>
        </a>
